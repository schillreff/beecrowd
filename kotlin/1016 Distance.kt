...
//  constant speed of 60 km/h and the car Y leaves with a constant
// speed of 90 km / h.
...
fun main(args: Array<String>) {
    ...
    val inputValue = reader.readLine().toDouble()

    val minutes = inputValue * 2

    println("${minutes.toInt()} minutos")
}
