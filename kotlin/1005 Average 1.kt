...
fun calculateAverage(valueA: Double, valueB: Double): String {
    val average = (valueA * 3.5 + valueB * 7.5) / 11
    return "MEDIA = %.5f".format(average)
}
...
fun main(args: Array<String>) {
    ...
    println(calculateAverage(valueA, valueB))
}
