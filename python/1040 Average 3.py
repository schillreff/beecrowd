...
#  average was 7.0 or more, print the message "Aluno aprovado."
# (Approved Student). If the average was less than 5.0, print the message:
# "Aluno reprovado." (Reproved Student). If the average was
# between 5.0 and 6.9, including these, the program must print the message
...
#  and print the message “Aluno aprovado.” (Approved student)
#  in case of average 5.0 or more) or "Aluno reprovado." (Reproved student)
# in case of average 4.9 or less. For these 2 cases
