...
# character T ('S' or 'M'), indicating the operation Sum or Average (Média in portuguese) to
# be performed with the elements of the array. Follow the 144 floating-point numbers of the array,
# considering that the elements are inserted line by line, from line 0 to line 11, always from left to right.
