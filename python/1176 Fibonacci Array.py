...
#  are 0 and 1 and each next term is the sum of the two preceding it. All the Fibonacci
#  numbers calculated in this program must fit in a unsigned 64 bits number.
