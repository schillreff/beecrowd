...
# help him through a simple program. To perform the calculation, you have
# to read spent time (in hours) and the same average speed (km/h). In this way,
...
liters = (spendTime * averageSpeed) / 12
