...
# The input may have, for example, the numbers ​​21 21 15 30. In this case,
#  the number 21 is assumed for X, The numbers 21 and 15 must be ignored
# because they are smaller or equal to X. The number 30 is within the
#  specification (greater than X) and is valid. So, the final result
#  must be 2 for this test case, because the sum (21 + 22) is bigger than 30.
